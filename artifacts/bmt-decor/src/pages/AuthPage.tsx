    ...
    <div className="relative flex items-center justify-center w-64 h-64 mx-auto">
      <div
        ...
        style={{
          ...
          boxShadow: "0 0 18px rgba(255,123,0,0.15)",
      ...
      >
        <div
          style={{
            ...
            borderRadius: "50%",
            background: "#ff7b00",
            boxShadow: "0 0 16px 4px rgba(255,123,0,0.8)",
          }}
        />
      </div>
      ...
      <div
        style={{
          ...
          boxShadow: "0 0 12px rgba(255,123,0,0.08)",
      ...
      >
        <div
          style={{
            ...
            boxShadow: "0 0 10px 3px rgba(255,255,255,0.4)",
          }}
        />
      </div>
      ...
      <div
        ...
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle at 35% 35%, rgba(255,150,50,0.9) 0%, rgba(255,100,0,0.7) 40%, rgba(200,60,0,0.5) 70%, rgba(10,14,22,0.9) 100%)",
          boxShadow:
            "0 0 40px 12px rgba(255,100,0,0.35), 0 0 80px 24px rgba(255,80,0,0.15), inset 0 0 30px rgba(255,180,80,0.2)",
      ...
      >
        <Sparkles
          style={{ color: "rgba(255,220,160,0.9)", width: 32, height: 32 }}
        />
      </div>
    </div>
  );
  ...
  return (
    <div className="space-y-1.5">
      <Label className="text-white/60 text-xs font-medium uppercase tracking-widest">
        {label}
        {optional && (
          <span className="ml-1 text-white/30 normal-case tracking-normal text-xs font-normal">
            (tùy chọn)
          </span>
        )}
      </Label>
...
export default function AuthPage() {
  ...
  const eyeBtn = (show: boolean, toggle: () => void) => (
    <button
      type="button"
      onClick={toggle}
      className="text-white/25 hover:text-orange-400 transition-colors duration-200"
    >
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 60% 50% at 20% 50%, rgba(255,100,0,0.08) 0%, transparent 70%)",
        }}
      />
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          background:
            "radial-gradient(ellipse 40% 40% at 80% 80%, rgba(255,80,0,0.06) 0%, transparent 70%)",
        }}
      />
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_3fr] gap-8 lg:gap-0 items-center min-h-[90vh] lg:min-h-0">
          ...
          <motion.div
            ...
            className="hidden lg:flex flex-col items-center justify-center px-8 py-12"
          >
            <div className="mb-10">
              <OrbitalCore />
            </div>
            ...
            <div className="text-center space-y-4">
              <div className="flex items-center justify-center gap-2 mb-3">
                ...
                <span
                  ...
                  style={{ color: "rgba(255,123,0,0.8)" }}
                >
                  BMT Decor
                </span>
              </div>
              ...
              <h1
                ...
                style={{
                  background: "linear-gradient(135deg, #ffffff 0%, rgba(255,180,80,0.9) 50%, rgba(255,100,0,0.8) 100%)",
          ...
          >
            <div
              className="dimensional-glass w-full max-w-md rounded-2xl p-8"
              style={{
                background: "rgba(15,19,28,0.82)",
                backdropFilter: "blur(12px)",
                WebkitBackdropFilter: "blur(12px)",
                border: "1px solid rgba(255,255,255,0.07)",
                boxShadow: "0 0 0 1px rgba(255,123,0,0.05), 0 24px 64px rgba(0,0,0,0.6), 0 0 60px rgba(255,100,0,0.04)",
              }}
            >
              <div className="flex items-center gap-3 mb-7 lg:hidden">
                ...
                <div>
                  ...
                  <div className="text-xs mt-0.5" style={{ color: "rgba(255,123,0,0.7)" }}>
              ...
              <div className="hidden lg:block mb-6">
                ...
                <p className="text-sm mt-1" style={{ color: "rgba(255,255,255,0.35)" }}>
                  Đăng nhập để khám phá không gian của bạn
                </p>
              </div>
              ...
              <Tabs defaultValue="login" className="w-full">
                ...
                >
                  <TabsTrigger
                    value="login"
                    className="flex-1 text-white/50 data-[state=active]:text-white rounded-lg py-2.5 text-sm font-medium transition-all duration-250"
                    style={{
                      ["--tw-ring-shadow" as string]: "none",
                    }}
                  >
                    <span className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-orange-500 data-[state=active]:to-orange-600 bg-clip-text">
                      Đăng nhập
                    </span>
                  </TabsTrigger>
                  <TabsTrigger
                ...
                <TabsContent value="login">
                  <form onSubmit={handleLogin} className="space-y-4">
                    <FieldInput
                      ...
                      onChange={(v) => setLoginForm((p) => ({ ...p, phone: v }))}
                    ...
                    <FieldInput
                      ...
                      rightEl={eyeBtn(showLoginPassword, () =>
                    ...
                    <div className="flex justify-end -mt-1">
                      <button
                        type="button"
                        className="text-xs transition-colors duration-200 hover:text-orange-300"
                        style={{ color: "rgba(255,123,0,0.75)" }}
                      >
                        Quên mật khẩu?
                      </button>
                    </div>
                    ...
                    <AnimatePresence>
                      {loginError && (
                        <motion.div
                          ...
                          animate={{ opacity: 1, y: 0 }}
                          exit={{ opacity: 0 }}
                          className="rounded-xl px-3.5 py-2.5 text-red-400 text-sm"
                          style={{
                    ...
                    <button
                      ...
                      className="glow-btn w-full flex items-center justify-center gap-2 py-3 rounded-xl text-white font-semibold text-sm transition-all duration-300 disabled:opacity-60"
                      style={{
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2.5 py-2.5 rounded-xl text-sm font-medium transition-all duration-200"
                      style={{
                        background: "rgba(255,255,255,0.04)",
                ...
                <TabsContent value="register">
                  <form onSubmit={handleRegister} className="space-y-3.5">
                    ...
                    <FieldInput
                      ...
                      rightEl={eyeBtn(showRegisterPassword, () =>
                        setShowRegisterPassword((x) => !x)
                      )}
                    />
                    ...
                    <FieldInput
                      ...
                      rightEl={eyeBtn(showConfirmPassword, () =>
                    ...
                    <button
                      ...
                      className="glow-btn w-full flex items-center justify-center gap-2 py-3 rounded-xl text-white font-semibold text-sm transition-all duration-300 disabled:opacity-60 mt-1"
                      style={{
                        background: "linear-gradient(135deg, #ff7b00, #ff4800)",
                        boxShadow: "0 4px 20px rgba(255,100,0,0.3)",
                      }}
